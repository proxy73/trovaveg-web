...
| Documento | Contenuto |
|-----------|-----------|
| [factsheet-it.md](./factsheet-it.md) | Scheda fatti verificati |
| [press-release-it.md](./press-release-it.md) | Comunicato stampa (versione lunga) |
| [press-release-short-it.md](./press-release-short-it.md) | Comunicato stampa (versione breve) |
| [faq-it.md](./faq-it.md) | FAQ per media |
| [media-list.md](./media-list.md) | Template elenco target (interno) |
| [outreach-runbook.md](./outreach-runbook.md) | Procedura outreach M34 |
| [assets/README.md](./assets/README.md) | Inventario e naming asset |
...
- Sito: trovaveg.com
- Bot Telegram: @TrovaVegBot (link pubblico sul sito)
